...
HT.Hexagon.prototype.draw = function(ctx) {
    ...
    if (!this.selected)
        ctx.strokeStyle = HT.Hexagon.Static.GRIDCOLOR;
    else
    ...
    if(HT.Hexagon.Static.ISVISIBLE)
        ctx.stroke();

    if (this.Id && HT.Hexagon.Static.SHOWLABELS)
    {
    ...
    if (this.PathCoOrdX !== null && this.PathCoOrdY !== null && typeof(this.PathCoOrdX) != "undefined" && typeof(this.PathCoOrdY) != "undefined" && HT.Hexagon.Static.SHOWNUMBERS)
    {
